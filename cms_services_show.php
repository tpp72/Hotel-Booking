    ...
    <form method="GET" action="">
        <div class="container">
            ...
            <div class="text-center mb-4">
                <a href="cms_services_insert.php" class="bi bi-plus btn btn-primary"> เพิ่มข้อมูลบริการเสริม</a>
                <a href="cms_services_update.php" class="bi bi-pencil btn btn-secondary"> แก้ไขข้อมูลบริการเสริม</a>
                <a href="cms_services_delete.php" class="bi bi-trash btn btn-danger"> ลบข้อมูลบริการเสริม</a>
            </div>
