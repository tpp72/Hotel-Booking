...
<head>
  ...
  <title>CS Hotel :: ลบข้อมูลประเภทห้องพัก</title>
...
<?php
    ...
    while($result_array = $result->fetch_assoc()) {
        ...
        echo "<td><center><a href='cms_exec.php?val=".md5($result_array['type_id'])."&roomtypes_chk=delete' target='_self' onclick='return confirm(\"ยืนยันการลบข้อมูล\")' role='button' class='bi bi-trash btn btn-danger'></a></center></td>";
        echo  "</tr>";
    }
        echo '</tbody>';
        echo '</table>';
