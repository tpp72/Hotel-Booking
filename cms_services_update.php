...
<?php
    ...
    while($result_array = $result->fetch_assoc()) {
        ...
        echo "<td><center><a href='cms_services_update2.php?val=".md5($result_array['service_id'])."'target='_self' role='button' class='bi bi-pencil btn btn-secondary'></a></center></td>";
        echo  "</tr>";
    }
        echo '</tbody>';
        echo '</table>';
