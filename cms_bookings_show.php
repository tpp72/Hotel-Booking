    ...
    <form method="GET" action="">
        <div class="container">
            ...
            <div class="text-center mb-4">
                <a href="cms_bookings_insert.php" class="bi bi-plus btn btn-primary"> เพิ่มข้อมูลการจองห้องพัก</a>
                <a href="cms_bookings_update.php" class="bi bi-pencil btn btn-secondary"> แก้ไขข้อมูลการจองห้องพัก</a>
                <a href="cms_bookings_delete.php" class="bi bi-trash btn btn-danger"> ลบข้อมูลการจองห้องพัก</a>
            </div>
