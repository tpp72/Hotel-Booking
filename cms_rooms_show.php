    ...
    <form method="post" action="">
        <div class="container">
            ...
            <div class="text-center mb-4">
                <a href="cms_rooms_insert.php" class="bi bi-plus btn btn-primary"> เพิ่มข้อมูลห้องพัก</a>
                <a href="cms_rooms_update.php" class="bi bi-pencil btn btn-secondary"> แก้ไขข้อมูลห้องพัก</a>
                <a href="cms_rooms_delete.php" class="bi bi-trash btn btn-danger"> ลบข้อมูลห้องพัก</a>
            </div>
